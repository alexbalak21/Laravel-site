...
@php
    $baseClasses = 'font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none focus:ring-4';
    ...
    $variants = [
        ...
        'alternative' => 'text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700',
        ...
        'yellow' => 'text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-yellow-300 dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-900',
    ...
    $classes = $baseClasses . ' ' . ($variants[$type] ?? $variants['default']);
@endphp
